...
fun AudioQuality.userVisibleLabel(context: Context): String =
    when (this) {
        ...
        AudioQuality.LOSSLESS_WHEN_AVAILABLE -> context.getString(R.string.audio_quality_lossless) + " (when available)"
...
fun DownloadQuality.userVisibleLabel(context: Context): String =
    when (this) {
        ...
        DownloadQuality.LOSSLESS_WHEN_AVAILABLE -> context.getString(R.string.audio_quality_lossless) + " (when available)"
