...
import com.nivukx.music.constants.DiscordActivityDetailsKey
import com.nivukx.music.constants.DiscordActivityNameKey
import com.nivukx.music.constants.DiscordActivityPlatformKey
import com.nivukx.music.constants.DiscordActivityStateKey
import com.nivukx.music.constants.DiscordActivityTypeKey
import com.nivukx.music.constants.DiscordLargeImageCustomUrlKey
import com.nivukx.music.constants.DiscordLargeImageTypeKey

import com.nivukx.music.constants.DiscordPresenceStatusKey
import com.nivukx.music.constants.DiscordShowWhenPausedKey
import com.nivukx.music.constants.DiscordSmallImageCustomUrlKey
import com.nivukx.music.constants.DiscordSmallImageTypeKey
import com.nivukx.music.constants.DiscordSmallImageTypeKey
import com.nivukx.music.db.entities.Song
import com.nivukx.music.discord.DiscordActivityPlatform
import com.nivukx.music.discord.DiscordActivityType
import com.nivukx.music.discord.DiscordOnlineStatus
import com.nivukx.music.discord.DiscordPresenceActivity
import com.nivukx.music.discord.DiscordPresenceAssets
import com.nivukx.music.discord.DiscordPresenceButton
import com.nivukx.music.discord.DiscordPresenceTimestamps
import com.nivukx.music.discord.DiscordSocialPresenceClient
import com.nivukx.music.discord.DiscordStatusDisplayType
...
class DiscordRPC(
    ...
    private suspend fun resolveButtons(song: Song): List<DiscordPresenceButton> {
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Nivukx"
        ...
        val button2CustomUrl =
            context.dataStore[DiscordActivityButton2CustomUrlKey]
                ?: "https://github.com/nivash01/Echo"
