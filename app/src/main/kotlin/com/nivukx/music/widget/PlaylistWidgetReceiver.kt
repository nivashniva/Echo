...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.nivukx.echo.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.nivukx.echo.widget.playlists.UPDATE_WIDGET"
