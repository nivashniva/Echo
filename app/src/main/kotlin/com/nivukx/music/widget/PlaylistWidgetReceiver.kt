...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.nivukx.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.nivukx.music.widget.playlists.UPDATE_WIDGET"
