...
import com.nivukx.music.db.daos.SpeedDialDao
import com.nivukx.music.db.entities.AlbumArtistMap
import com.nivukx.music.db.entities.AlbumEntity
...
import com.nivukx.music.db.entities.PlayCountEntity
import com.nivukx.music.db.entities.PlaylistEntity
import com.nivukx.music.db.entities.PlaylistSongMap
import com.nivukx.music.db.entities.PlaylistSongMapPreview
...
import com.nivukx.music.db.entities.SetVideoIdEntity
import com.nivukx.music.db.entities.SongAlbumMap
import com.nivukx.music.db.entities.SongArtistMap
import com.nivukx.music.db.entities.SongEntity
import com.nivukx.music.db.entities.SpeedDialItem
import com.nivukx.music.db.entities.SortedSongAlbumMap
import com.nivukx.music.db.entities.SortedSongArtistMap
import com.nivukx.music.extensions.toSQLiteQuery
...
abstract class InternalDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context): InternalDatabase =
            Room.databaseBuilder(context.applicationContext, InternalDatabase::class.java, DB_NAME)
                .addMigrations(
                    MIGRATION_1_2, MIGRATION_21_24, MIGRATION_22_24, MIGRATION_24_25,
                    MIGRATION_27_28, MIGRATION_28_29, MIGRATION_29_30, MIGRATION_31_32,
        ...
        fun newInstance(context: Context): MusicDatabase = MusicDatabase(getInstance(context))
    }
}
